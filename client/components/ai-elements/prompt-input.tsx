  ...
  return (
    <Textarea
      className={cn(
        ...
        "max-h-48 min-h-10 2xl:min-h-16",
        "focus-visible:ring-0 font-inter font-medium max-2xl:!text-xs",
        className
      )}
      name="message"
      onChange={(e) => {
...
export const PromptInputSubmit = ({
  ...
  return (
    <Button
      ...
      size={size}
      type={status === "streaming" ? "button" : "submit"} // 🔹 don’t submit while streaming
      variant={variant}
      {...props}
      onClick={(e) => {
