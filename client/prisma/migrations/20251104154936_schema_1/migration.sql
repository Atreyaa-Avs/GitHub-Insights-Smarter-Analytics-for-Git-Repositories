...
CREATE TABLE "public"."GhUser" (
    ...
    CONSTRAINT "GhUser_pkey" PRIMARY KEY ("login")
);
...
-- CreateIndex
CREATE INDEX "ContributorRank_repo_id_idx" ON "public"."ContributorRank"("repo_id");

-- CreateIndex
CREATE INDEX "ContributorRank_contributions_idx" ON "public"."ContributorRank"("contributions");

-- CreateIndex
CREATE UNIQUE INDEX "repo_id_user_login" ON "public"."ContributorRank"("repo_id", "user_login");

-- CreateIndex
CREATE INDEX "Issue_repo_id_created_at_idx" ON "public"."Issue"("repo_id", "created_at");

-- CreateIndex
CREATE UNIQUE INDEX "repo_id_issue_number" ON "public"."Issue"("repo_id", "issue_number");

-- CreateIndex
CREATE INDEX "RepoLanguage_repo_id_idx" ON "public"."RepoLanguage"("repo_id");

-- CreateIndex
CREATE INDEX "RepoLanguage_bytes_of_code_idx" ON "public"."RepoLanguage"("bytes_of_code");

-- CreateIndex
CREATE UNIQUE INDEX "repo_id_language" ON "public"."RepoLanguage"("repo_id", "language");

-- CreateIndex
CREATE INDEX "ParticipationStats_repo_id_idx" ON "public"."ParticipationStats"("repo_id");

-- CreateIndex
CREATE UNIQUE INDEX "repo_id_week_start" ON "public"."ParticipationStats"("repo_id", "week_start");

-- CreateIndex
CREATE INDEX "Pull_repo_id_created_at_idx" ON "public"."Pull"("repo_id", "created_at");

-- CreateIndex
CREATE UNIQUE INDEX "repo_id_pr_number" ON "public"."Pull"("repo_id", "pr_number");

-- CreateIndex
CREATE UNIQUE INDEX "Release_release_id_key" ON "public"."Release"("release_id");

-- CreateIndex
CREATE INDEX "WeeklyCommit_repo_id_idx" ON "public"."WeeklyCommit"("repo_id");
...
-- AddForeignKey
ALTER TABLE "public"."ParticipationStats" ADD CONSTRAINT "ParticipationStats_repo_id_fkey" FOREIGN KEY ("repo_id") REFERENCES "public"."Repo"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Pull" ADD CONSTRAINT "Pull_repo_id_fkey" FOREIGN KEY ("repo_id") REFERENCES "public"."Repo"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."WeeklyCommit" ADD CONSTRAINT "WeeklyCommit_repo_id_fkey" FOREIGN KEY ("repo_id") REFERENCES "public"."Repo"("id") ON DELETE CASCADE ON UPDATE CASCADE;
